...
export default function Contact() {
  ...
  return (
    <section className="space-y-12 md:space-y-20 max-w-xl">
      <div>
        <h1 className="font-display text-5xl md:text-6xl lg:text-7xl font-semibold text-forest animate-fade-up">Contact</h1>
